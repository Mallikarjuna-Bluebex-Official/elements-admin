...
{/* <div className="hidden md:block text-3xl font-bold bg-gradient-to-r from-[#6a82fb] to-[#fc5c7d] bg-clip-text text-transparent">
  Elements Admin
    ...
    <div className="hidden sm:block text-xl font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
      Elements Admin
      </div>
        ...
        <div className="relative" ref={settingsRef}>
          ...
          {isSettingsOpen && (
            <div className="absolute right-0 top-10 bg-white shadow-lg rounded-lg w-48 overflow-hidden z-50">
              ...
              {/*<Link to='/promo'><li onClick={() => setSettingsOpen(false)} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Promo</li></Link> */}            
              <Link to='/media'><li onClick={() => setSettingsOpen(false)} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Media</li></Link>             
              </ul>
            </div>
          )}
        </div>
